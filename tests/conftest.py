...
from annophis_mlhub.app import create_app
...
def _use_real_config():
    """Restore real config path so annotators load from annophis_mlhub.toml."""
    from annophis_mlhub.config import CONFIG_PATH
